  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-2xl mx-auto p-6">
        ...
        <form onSubmit={handleLink} className="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-4">
          <h2 className="font-semibold">Link Parent to Student</h2>
          <div>
            <label className="text-gray-400 text-sm mb-1 block">Parent</label>
            <select
