  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-6">
          <label className="text-gray-400 text-sm mb-1 block">Select Class</label>
          <select
            value={selectedClass}
            onChange={(e) => setSelectedClass(e.target.value)}
            className="bg-gray-900 border border-gray-800 text-white rounded-lg px-4 py-3 text-sm outline-none"
          >
            {classes.map((c) => (
        ...
        {showForm && (
          <form onSubmit={handleSubmit} className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-6 space-y-4">
            ...
            <div>
              <label className="text-gray-400 text-sm mb-1 block">Teacher</label>
              <select
            ...
            <div className="flex gap-3">
              <button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg text-sm">Save</button>
              ...
              {grouped[day].length === 0 ? (
                ...
                <div className="space-y-2">
                  {grouped[day].map((t: any) => (
                    <div key={t.id} className="bg-gray-900 border border-gray-800 rounded-xl px-5 py-4 flex items-center justify-between">
                      <div>
