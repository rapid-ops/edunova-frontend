      ...
      <div className="max-w-2xl mx-auto p-6">
        {loading ? (
          ...
          <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-6 text-center">
            ...
            <p className="text-gray-400 text-sm mt-1">No outstanding fees</p>
          </div>
        ) : (
            ...
            {fees.map((f) => (
              <div key={f.id} className="bg-gray-900 border border-gray-800 rounded-xl p-5">
                ...
                <button
                  ...
                  className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-lg text-sm font-medium transition disabled:opacity-50"
                >
                  {paying === f.id ? 'Redirecting to Paystack...' : 'Pay Now'}
                </button>
              </div>
            ))}
          </div>
